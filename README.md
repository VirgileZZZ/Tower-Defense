...
bugs a fix ; 
les skelletes de notre necromancier se font target et tuer par nos tours ,
également les skelletes passent sur les zombie et n'echangent pas leurs pv contre des degats au contact , 
aussi le neromencer ne tire pas , il ne fais pas de degats
et le necromencer fais spawn des skelletes alors qu"il n'as pas tué d'enemies

Le nécromencien enemmis ne fais pas spawn ses monstres la ou il est , ses monstres spawn un a des endroit random mdans le chemain

electro a un bugs , les particules restent a la fin de la game
et son model 3D est bugé

et aussi tt les nouvelle vagues , la map se reset , genre ca reste la mm map mais les elements de decors rebougent

Le minigers fais laguer et crash le jeu

fais aussi en sorte que quand un enemi est ralenti par le frost , sa vitesse d'atack de n'importe quoi est aussi ralenti , marche sur les mmini boss mais pas les boss

aussi dans la map le volcan est sur le chemain