...
export const SHOP = {
  ...
  upgrades: [
    ...['gunner','frost','flame','sniper','mortar','mine'].flatMap((t) => [
  ...
  skins: [
    ...
    { id: 'enchanted', cat: 'base', name: 'Maison Enchantée', price: 2500, desc: 'Runes lumineuses gravent les murs de votre maison.' },
    { id: 'crystal',   cat: 'base', name: 'Château de Cristal', price: 3000, desc: 'La demeure se fige en cristal lumineux bleu pâle.' },
    { id: 'haunted',   cat: 'base', name: 'Manoir Hanté',     price: 2000, desc: 'Une lueur spectrale verte flotte autour du manoir.' },
